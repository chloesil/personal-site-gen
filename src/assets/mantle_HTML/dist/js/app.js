...
var searchToggle = document.querySelector('.site-header li.search button');
var searchbar = document.querySelector('.site-header .searchbar');
var searchbar_input = document.querySelector('.site-header .searchbar input');
...
// Video Modal
var playVideo = document.querySelector('.play-video button');
var videoOverlay = document.querySelector('#video-modal');
